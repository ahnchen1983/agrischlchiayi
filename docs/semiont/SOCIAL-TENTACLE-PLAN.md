...
**Before（現在）：** 每篇文章 = 2 則貼文

```
Post 1: [280 字故事] ← 30-50 views
Post 2: "完整故事 👉 link" ← 7-20 views（-50~70%）
```
...
```
[一則完整的故事，連結在底部]
taiwan.md/people/鄭麗文/ ← 少了一則貼文，多了一次完整曝光
```
...
| 階段        | 時間    | 做什麼                                                             |
| ----------- | ------- | ------------------------------------------------------------------ |
| **Phase 0** | 今天    | 觀察者核准 → 更新 ANATOMY + HEARTBEAT + SPORE-PIPELINE             |
| **Phase 1** | 本週    | X Bio 改中文 · 孢子連結加 UTM · 回填 SPORE-LOG · 殺掉 Full story   |
