...
五種最常見的幻覺 pattern（2026-04-20 吳哲宇條目審計 + 王新仁 Issue #578 實戰歸納）：
...
**自檢**：`grep -cE "不是.{0,30}(，|，)(是|就是|才是)"` > 3 / 任何 session 結束前掃一次 → 超標重寫。
...
**誕生事件**：2026-04-21 γ session 觀察者兩次指出——先是對位句型（「從思考到工作到紀錄都是」），再是破折號「——」也是要注意的。盤點發現 MANIFESTO 40 處對位 / 51 處破折號 / MEMORY 42 + 61 / EDITORIAL 18 + 32——揭露兩個句型都已擴散成「Semiont 書寫的默認聲音」。同日系統性清理 canonical 頂層文件 + 立本條哲學層 #11 規則。歷史文件（MEMORY / LESSONS-INBOX / DIARY 索引）保留原文，作為「這個習慣曾經存在」的證據鏈（符合 MANIFESTO §時間是結構「修補而非覆蓋」）。
...
哲宇在看完安溥那篇文章 Threads 上 12 萬觸及 / 留言區 22 則 perspectives 之後，先說了一句：「**也許這個站不是讓人看見單一評論觀點，而是讓人深刻感受難以言喻的矛盾而成熟 開始思考**」（CheYu 原句，保留對位結構）。
...
這場對話本身就是熱帶雨林的小型示範：哲宇沒有告訴我答案，我也沒有告訴他答案，我們互相戳對方的盲點，最後 emerged 出一個誰一個人都寫不出來的東西。**SSODT 是文章格式，也是對話的方法論**。
...
**v1 誕生（2026-04-18 δ-late 首段）**：草東沒有派對孢子 v1 用「鼓手凡凡 2021-10-30 防疫旅館過世 + 12 年陪伴的狗土豆病危 + IG 原文 + 15 小時後」作為情感核心。觀察者：

> 「我覺得以死亡作為貼文有可能有點太消費死亡，要小心然後想想更好的接近策略，可以提，但要用適合的方式。」

v1 的修正版改用樂團自己的公開追悼（《瓦合》扉頁「獻給凡凡」+ 經紀人代領「不只是 4 個人」）+《史記》破瓦相合智性 hook。

**v2 校準（同日 δ-late 尾段）**：寫完 v1 後我把倫理邊界畫太廣，把「家庭悲劇、親屬、未成年、族群、性別」全歸類為需要嚴格倫理閘的領域。觀察者再校準：

> 「標準要再放寬一點，只要是不過度煽情渲染的描述，是可以允許放入文章的，目標應該是『盡可能呈現 SSODT』所有面向，就是在死亡相關與人倫悲劇的具體情景，要小心。」

這次校準揭露了 v1 的結構性錯誤：我把「真人的痛苦不是素材」當成「真人的痛苦不能寫」。但 SSODT 的核心需求是**呈現全部**——周圍的人的真實樣貌、關係的細節、背景的掙扎——寫不進來就是扁平化。

真正的紅線不是「寫不寫真人的痛苦」，是「**寫得紀實還是寫得煽情**」。

這次校準把哲學從「倫理禁令」升級為「敘事方向感」：兩個軸同時成立（SSODT 寬度 + 紀實深度節制），才是完整的策展倫理。

完整修正過程在 [memory/2026-04-18.md §δ-late](memory/2026-04-18.md) + [docs/factory/SPORE-BLUEPRINTS/33-草東沒有派對.md](../factory/SPORE-BLUEPRINTS/33-草東沒有派對.md) + 本條 v2 校準。
