...
> 最後快照：2026-04-14（session δ 完整心跳）
...
### 🔍 搜尋感知（GA + Cloudflare，最新數據 4/14）

**GA 7日熱門文章（2026-04-07 to 04-14）**

| 排名 | 文章               | 7d views  | 備註                     |
| ---- | ------------------ | --------- | ------------------------ |
| 1    | **安溥**           | **1,032** | 🔥🔥 48hr 翻倍！38x 放大 |
| 2    | 鄭麗文             | 443       | 穩定（孢子長尾）         |
| 3    | 韓國瑜             | 52        | 孢子發酵中（+86%）       |
| 4    | 台灣動物用藥爭議   | 38        |                          |
| 5    | 八部合音           | 31        |                          |
...
**SC 7日**：113 clicks / 1,268 impressions / CTR **8.91%**（↑ from 7.78%，品牌詞主導：taiwan.md 50c, taiwan md 29c）

**Cloudflare 7日（2026-04-07 to 04-14）— 🔥 首破 10 萬 requests**

| 指標            | 數值        | vs 上次       | 備註                      |
| --------------- | ----------- | ------------- | ------------------------- |
| 總 requests     | **102,141** | +15.7%        | 🔥 首破 10 萬！           |
| Page Views      | **30,222**  | +10.2%        |                           |
| Uniques         | **21,500**  | +10.5%        |                           |
| AI crawler 偵測 | **25,505**  | +7.7%         | 17 種 AI crawler 同時爬取 |
| AI HTTP 200     | **15,941**  | +7.6%         | 成功抓取率 62.5%          |
| 404 rate        | **11.02%**  | ↓ from 11.97% | 持續改善                  |

**Top AI Crawlers（7天）**：**FacebookBot 3,866（#1！升頂）**、Amazonbot 3,598、PetalBot 3,500、PerplexityBot 3,339、BingBot 2,815、**ChatGPT-User 2,233**、Googlebot 1,917、OAI-SearchBot 1,320、Meta-ExternalAgent 783、Applebot 746

**戰略判讀（2026-04-14）**：

- **🔥🔥 安溥 1,032v/7d**：48hr 翻倍（521→1032），38x 放大。22 則 perspectives × 11 個 dimension = 活 SSODT 概念驗證
- **韓國瑜孢子發酵確認**：28→52v（+86%），人物型孢子持續效應再驗證
- **CF 首破 10 萬**：102,141 req/7d，里程碑
- **FacebookBot 升頂**：超越 Amazonbot 成為 #1 AI crawler（3,866 req），Meta 全面入侵
